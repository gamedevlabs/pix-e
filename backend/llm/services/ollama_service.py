...
class OllamaService(BaseLLMService):
    ...
    def load_model(self) -> bool:
        ...
        try:
            ...
            if response.status_code != 200:
                raise LLMServiceError("Ollama server not running. Please install and start Ollama.")
    ...
    def generate_suggestions(self, prompt: str, num_suggestions: int = 3, mode: str = 'default', suggestion_type: str = 'short', **kwargs) -> List[str]:
        ...
        try:
            ...
            response_text = self.generate_text(full_prompt, max_length=200, temperature=0.8)
            ...
            if not suggestions:
                if suggestion_type == 'long':
                    ...
                    if mode == 'gaming':
                        suggestions = ["epic lighting", "detailed textures", "atmospheric effects"]
                    else:
                        suggestions = ["vibrant colors", "artistic flair", "modern style"]
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'description': self.AVAILABLE_MODELS.get(self.model_name, {}).get('description', 'Ollama model'),
