    ...
    async def run(self, request: LLMRequest) -> Any:
        ...
        if concept_fit_result and concept_fit_result.success:
            ...
            if has_gaps or missing_aspects:
                ...
                resolution_tasks.append(("additions", additions_agent, additions_data))
        ...
        if contradictions_result and contradictions_result.success:
            ...
            contradictions_list = contradictions_result.data.get("contradictions", [])
        ...
        if resolution_tasks:
            resolution_agents = [(name, agent) for name, agent, _ in resolution_tasks]
