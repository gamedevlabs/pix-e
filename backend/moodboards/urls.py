...
urlpatterns = [
    ...
    path(
        "api/moodboards/<uuid:moodboard_pk>/comments/",
        MoodboardCommentViewSet.as_view({"get": "list", "post": "create"}),
        name="moodboard-comments-list",
    ),
    path(
        "api/moodboards/<uuid:moodboard_pk>/comments/<uuid:pk>/",
