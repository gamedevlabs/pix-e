...
router.register(r'images', views_production.MoodboardImageViewSet, basename='moodboard-image')
router.register(r'comments', views_production.MoodboardCommentViewSet, basename='moodboard-comment')
router.register(r'shares', views_production.MoodboardShareViewSet, basename='moodboard-share')
...
urlpatterns = [
    ...
    path('api/v1/generate-images/', views_production.generate_images_legacy, name='generate-images-legacy'),
    path('api/v1/moodboards/<int:moodboard_id>/generate/', views_production.generate_images_legacy, name='generate-images-legacy-detail'),
