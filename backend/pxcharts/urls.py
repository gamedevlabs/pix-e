...
from .views import PxChartContainerViewSet, PxChartEdgeViewSet, PxChartViewSet, PxLockAssignmentViewSet
...
charts_router.register(
    r"pxlocks", PxLockAssignmentViewSet, basename="px_lock_assignment"
)
