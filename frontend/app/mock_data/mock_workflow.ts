...
export const WORKFLOW_TEMPLATE: PhaseTemplate[] = [
  ...
  },
  {
    ...
    steps: [
      {
        id: 'px-1',
        name: 'Create a PX Chart',
        description: 'Build your first chart and understand the canvas.',
        route: '/pxcharts',
        substeps: [
          { id: 'px-1-1', name: 'Open Player Experience', route: '/pxcharts' },
          { id: 'px-1-2', name: 'Create your first chart', route: '/pxcharts' },
        ],
      },
      {
        id: 'px-2',
        ...
        route: '/pxnodes',
        substeps: [
          { id: 'px-2-1', name: 'Create a node', route: '/pxnodes' },
          {
            id: 'px-2-2',
            name: 'Create a component definition',
            route: '/pxcomponentdefinitions',
          },
          { id: 'px-2-3', name: 'Attach components to a node', route: '/pxnodes' },
          { id: 'px-2-4', name: 'Connect nodes in the chart', route: '/pxnodes' },
        ],
      },
    ],
  },
