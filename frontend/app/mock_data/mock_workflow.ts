...
export const WORKFLOW_TEMPLATE: PhaseTemplate[] = [
    ...
    steps: [
      {
        ...
        substeps: [
          {
            id: 'user-onb-2-0',
            name: 'Open the Create page',
            route: '/create',
            description: 'Start the process of setting up your first project.',
          },
          {
            id: 'user-onb-2-1',
            name: 'Project Information',
            route: '/create',
            description: 'Provide basic information for your new project.',
          },
          {
            id: 'user-onb-2-2',
            name: 'Project Details',
            route: '/create',
            description: 'Fill in specific details about what your project entails.',
          },
          {
            id: 'user-onb-2-3',
            name: 'Review Project Settings',
            route: '/create',
            description: 'Finalize and review your project configuration before creation.',
          },
        ],
      },
      {
    ...
    steps: [
      {
        ...
        description: 'Start by defining a core idea that represents what your game is about.',
        route: '/pillars',
        substeps: [
          {
            id: 'pillars-1-1',
      ...
      },
      {
        ...
        description: 'Use AI feedback to refine and strengthen your idea.',
        route: '/pillars',
        substeps: [
          {
            id: 'pillars-2-1',
      ...
      },
      {
        ...
        description: 'Add more detail and explore how your idea could evolve.',
        route: '/pillars',
        substeps: [
          {
            id: 'pillars-3-1',
      ...
      },
      {
        ...
        description: 'Learn how to interpret different types of AI feedback.',
        route: '/pillars',
        substeps: [
          {
            id: 'pillars-4-1',
    ...
    steps: [
      {
        ...
        description: 'Build a chart that represents how players move through your game.',
        route: '/pxcharts',
        substeps: [
          {
            id: 'px-1-1',
    ...
    steps: [
      {
        ...
        description: 'Understand how your design aligns with player perception.',
...

  {
    ...
    completionMessage: "Nice! You've explored all major features of the platform.",
    steps: [
      {
        id: 'mse-1',
        name: 'Explore the evaluator',
        description: 'Take a quick look at how scripts can be analyzed.',
...
function instantiatePhase(phase: PhaseTemplate, isFirstPhase: boolean): WorkflowInstance {
  const now = new Date().toISOString()
  return {
    id: `wf-user-${phase.id}`,
    projectId: 'user',
