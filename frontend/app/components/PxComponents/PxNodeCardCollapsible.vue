  ...
  <UContextMenu :items="menuItems" :disabled="!!(isBeingEdited || llmFeedback)">
    <UCard class="hover:shadow-lg transition" style="margin: -25px" @dblclick="onDbClick($event)">
      ...
      <template #footer>
        ...
        <div v-else-if="!isCollapsed && !isBeingEdited" class="flex-col justify-between">
          <div class="flex justify-between gap-2">
            ...
            <div class="flex gap-2">
              ...
              <UButton color="secondary" variant="soft" @click="handleSwitchNode()"
                >Switch Node</UButton
              >
              <UButton color="error" variant="soft" @click="handleDeleteContainer()"
                >Delete</UButton
              >
            </div>
          </div>
        ...
        <div v-else-if="!isCollapsed" class="flex gap-2">
